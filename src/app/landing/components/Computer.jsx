...
const Computer = () => {
  ...
  <div className="h-screen flex justify-center items-center pt-10 bg-gray-950">
    <div className=' z-10 w-2/3 relative'>
        <Image src={laptop} alt="Computador" className='w-fulls lg:h-[30rem] h-auto  lg:object-contain block' />
